  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col gap-4 p-4">
      <div className="flex flex-wrap items-start gap-2">
        <div className="flex min-w-0 flex-col gap-0.5 rounded-lg bg-primary px-3 py-2 text-primary-foreground shadow-sm">
      ...
      <div className="touch-pan-scroll min-h-0 flex-1 overflow-auto rounded-lg border bg-card p-3">
        <div
            ...
            return segments.map((seg, segIdx) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="line-clamp-2 w-full text-[10px] font-medium leading-tight text-primary/90 sm:text-xs">
                    {fx.name}
                  </span>
                  {conflict && (
                    <span className="mt-auto inline-flex items-center gap-0.5 text-[10px] text-destructive">
