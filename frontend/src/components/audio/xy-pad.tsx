            ...
            {children ?? (
                ...
                >
                    <XYPadPrimitive.Grid
                        ...
                        <XYPadPrimitive.GridLine orientation="vertical" position={0.5}
                                                 className="bg-border"/>
                        <XYPadPrimitive.GridLine orientation="horizontal" position={0.5}
                                                 className="bg-border"/>
                        <XYPadPrimitive.GridLine orientation="vertical" position={0.25}
                                                 className="bg-border/60"/>
                        <XYPadPrimitive.GridLine orientation="vertical" position={0.75}
                                                 className="bg-border/60"/>
                        <XYPadPrimitive.GridLine orientation="horizontal" position={0.25}
                                                 className="bg-border/60"/>
                        <XYPadPrimitive.GridLine orientation="horizontal" position={0.75}
                                                 className="bg-border/60"/>
                    </XYPadPrimitive.Grid>
                    ...
                    <XYPadPrimitive.Cursor className="size-4">
                        ...
                        <XYPadPrimitive.CursorDot
                            className="bg-primary shadow-md ring-2 ring-background"/>
