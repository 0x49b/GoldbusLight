        ...
        >
            {children ?? (
                <KnobPrimitive.Slider
                    ...
                    <KnobPrimitive.Body
                        className="absolute inset-[12%] rounded-full bg-input/80 shadow-inner ring-1 ring-black/10 dark:ring-white/10"/>
                    <KnobPrimitive.Arc
                        className="text-primary [&_path]:stroke-current"
                        strokeWidth={3}
                    />
                    <KnobPrimitive.Indicator className="text-foreground [&_line]:stroke-current"
                                             strokeWidth={2.5}/>
                </KnobPrimitive.Slider>
            )}
        </KnobPrimitive.Root>
