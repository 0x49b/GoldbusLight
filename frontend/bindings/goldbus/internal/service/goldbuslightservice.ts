...
export function ActivateLicense(key: string): $CancellablePromise<license$0.LicenseInfo> {
    return $Call.ByID(3971834154, key).then(($result: any) => {
...
export function DeactivateLicense(): $CancellablePromise<license$0.LicenseInfo> {
    return $Call.ByID(4070010603).then(($result: any) => {
        return $$createType0($result);
    });
}
...
export function GetLicenseInfo(): $CancellablePromise<license$0.LicenseInfo> {
    return $Call.ByID(2899083377).then(($result: any) => {
        return $$createType0($result);
    });
}
...
const $$createType0 = license$0.LicenseInfo.createFrom;
...
const $$createType5 = controller$0.WLEDDevice.createFrom;
const $$createType6 = $Create.Array($$createType5);
const $$createType7 = controller$0.ControllerSnapshot.createFrom;
